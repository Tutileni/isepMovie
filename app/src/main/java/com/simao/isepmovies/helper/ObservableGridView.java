...
/**
    GridView que sa position de défilement peut être observée.
 */
public class ObservableGridView extends GridView implements Scrollable {

    // Les champs qui devraient être sauvegardés onSaveInstanceState
    ...
    // Champs qui n'ont pas besoin d'être enregistrés onSaveInstanceState
            ...
            switch (ev.getActionMasked()) {
                ...
                case MotionEvent.ACTION_MOVE:
                    ...
                    if (getCurrentScrollY() - diffY <= 0) {
                        ...
                        if (mIntercepted) {
                            // J'ai déjà envoyé l'événement ACTION_DOWN aux parents, alors arrêtez ici.
                            return false;
                        }

                        // Les applications peuvent définir la cible d'interception autre que le parent direct.
    ...
    public void setOnScrollListener(OnScrollListener l) {
        // Ne définissez pas l sur super.setOnScrollListener ().
        // l reçoit tous les événements via mScrollListener.
