...
/**
 * ListView que sa position de défilement peut être observée.
 */
        ...
        if (mCallbacks != null) {
            switch (ev.getActionMasked()) {
                case MotionEvent.ACTION_DOWN:
                    ...
                    // alors appelle-le ici.s might implement initialization codes to onDownMotionEvent,
                        ...
                        if (firstVisiblePosition - mPrevFirstVisiblePosition != 1) {
                            for (int i = firstVisiblePosition - 1; i > mPrevFirstVisiblePosition; i--) {
                                if (0 < mChildrenHeights.indexOfKey(i)) {
                                    ...
                                    // Approximer la hauteur de chaque objet au premier enfant visible.
                                    // Il peut être incorrect, mais sans cela, scrollY sera cassé
                                    // lors du défilement depuis le bas.
